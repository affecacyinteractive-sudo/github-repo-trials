...
"[project]/app/api/code-blocks/[blockId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    try {
        ...
        const block = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].codeBlock.findUnique({
            where: {
                id: blockId
            },
            include: {
        ...
        if (!block) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("code_block_not_found", "The requested code block was not found.", 404);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lm0tcu._.js.map