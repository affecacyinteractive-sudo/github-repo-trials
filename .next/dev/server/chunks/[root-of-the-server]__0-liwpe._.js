...
"[project]/app/api/files/[fileId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    try {
        const { fileId } = await params;
        const file = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sourceFile.findUnique({
            where: {
                id: fileId
            },
            include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-liwpe._.js.map