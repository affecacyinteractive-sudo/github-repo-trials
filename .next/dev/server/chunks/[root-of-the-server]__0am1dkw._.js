...
"[project]/app/api/ingest-jobs/[jobId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    try {
        ...
        const job = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].ingestJob.findUnique({
            where: {
                id: jobId
            }
        });
        if (!job) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("job_not_found", "The requested ingest job was not found.", 404);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0am1dkw._.js.map