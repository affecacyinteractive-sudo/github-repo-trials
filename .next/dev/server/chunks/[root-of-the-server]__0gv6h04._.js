...
async function getRustParser() {
    if (!parserPromise) {
        parserPromise = (async ()=>{
            const { Parser, Language } = await __turbopack_context__.A("[project]/node_modules/web-tree-sitter/web-tree-sitter.js [app-route] (ecmascript, async loader)");
            await Parser.init({
                locateFile (scriptName) {
                    return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", scriptName);
                }
            });
            const rustLanguage = await Language.load(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "parsers", "tree-sitter-rust.wasm"));
...
async function extractRustStructuralBlocks(sourceText) {
    const parser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rust$2d$parser$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRustParser"])();
    const tree = parser.parse(sourceText);
    const sourceBuffer = Buffer.from(sourceText, "utf8");
    const results = [];
    visitNode(tree.rootNode, []);
    ...
    try {
        ...
        for (const file of rustFiles){
            try {
                ...
                const blocks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rust$2d$structural$2d$extractor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractRustStructuralBlocks"])(content);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0gv6h04._.js.map