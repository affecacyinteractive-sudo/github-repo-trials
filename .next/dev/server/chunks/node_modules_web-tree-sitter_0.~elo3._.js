module.exports = [
"[project]/node_modules/web-tree-sitter/web-tree-sitter.wasm (static in ecmascript)", ((__turbopack_context__) => {

__turbopack_context__.q("/server/assets/web-tree-sitter.0bn_t5s-4l6cy.wasm");}),
"[project]/node_modules/web-tree-sitter/web-tree-sitter.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/web-tree-sitter/web-tree-sitter.js")}`;
    },
    get turbopackHot () {
...
var Edit = class {
    ...
    /** The start position of the change. */ startPosition;
    /** The end position of the change before the edit. */ oldEndPosition;
    /** The end position of the change after the edit. */ newEndPosition;
    /** The start index of the change. */ startIndex;
    /** The end index of the change before the edit. */ oldEndIndex;
    /** The end index of the change after the edit. */ newEndIndex;
...
var LookaheadIterator = class {
    ...
    /** @internal */ language;
    /** @internal */ constructor(internal, address, language){
        assertInternal(internal);
        this[0] = address;
        this.language = language;
    }
    /** Get the current symbol of the lookahead iterator. */ get currentTypeId() {
        return C._ts_lookahead_iterator_current_symbol(this[0]);
    }
    /** Get the current symbol name of the lookahead iterator. */ get currentType() {
        return this.language.types[this.currentTypeId] || "ERROR";
    }
    /** Delete the lookahead iterator, freeing its resources. */ delete() {
...
var Tree = class _Tree {
    ...
    /** @internal */ [0] = 0;
    // Internal handle for Wasm
    /** @internal */ textCallback;
    /** The language that was used to parse the syntax tree. */ language;
    /** @internal */ constructor(internal, address, language, textCallback){
        assertInternal(internal);
        this[0] = address;
        this.language = language;
        this.textCallback = textCallback;
    }
    /** Create a shallow copy of the syntax tree. This is very fast. */ copy() {
        const address = C._ts_tree_copy(this[0]);
        return new _Tree(INTERNAL, address, this.language, this.textCallback);
    }
    /** Delete the syntax tree, freeing its resources. */ delete() {
        C._ts_tree_delete(this[0]);
        this[0] = 0;
    }
    /** Get the root node of the syntax tree. */ get rootNode() {
   ...
   */ edit(edit) {
    ...
    /** Create a new {@link TreeCursor} starting from the root of the tree. */ walk() {
   ...
   */ getChangedRanges(other) {
    ...
    /** Get the included ranges that were used to parse the syntax tree. */ getIncludedRanges() {
...
var TreeCursor = class _TreeCursor {
    ...
    /** @internal */ // @ts-expect-error: never read
    [0] = 0;
    // Internal handle for Wasm
    /** @internal */ // @ts-expect-error: never read
    [1] = 0;
    ...
    /** Creates a deep copy of the tree cursor. This allocates new memory. */ copy() {
        const copy = new _TreeCursor(INTERNAL, this.tree);
        C._ts_tree_cursor_copy_wasm(this.tree[0]);
        unmarshalTreeCursor(copy);
        return copy;
    }
    /** Delete the tree cursor, freeing its resources. */ delete() {
        marshalTreeCursor(this);
        C._ts_tree_cursor_delete_wasm(this.tree[0]);
        this[0] = this[1] = this[2] = 0;
    }
    /** Get the tree cursor's current {@link Node}. */ get currentNode() {
        marshalTreeCursor(this);
   ...
   */ get currentFieldId() {
    ...
    /** Get the field name of this tree cursor's current node. */ get currentFieldName() {
   ...
   */ get currentDescendantIndex() {
    ...
    /** Get the type of the cursor's current node. */ get nodeType() {
        return this.tree.language.types[this.nodeTypeId] || "ERROR";
    }
    /** Get the type id of the cursor's current node. */ get nodeTypeId() {
        marshalTreeCursor(this);
        return C._ts_tree_cursor_current_node_type_id_wasm(this.tree[0]);
    }
    /** Get the state id of the cursor's current node. */ get nodeStateId() {
        marshalTreeCursor(this);
        return C._ts_tree_cursor_current_node_state_id_wasm(this.tree[0]);
    }
    /** Get the id of the cursor's current node. */ get nodeId() {
        marshalTreeCursor(this);
   ...
   */ get nodeIsMissing() {
    ...
    /** Get the string content of the cursor's current node. */ get nodeText() {
        marshalTreeCursor(this);
    ...
    /** Get the start position of the cursor's current node. */ get startPosition() {
        marshalTreeCursor(this);
        C._ts_tree_cursor_start_position_wasm(this.tree[0]);
        return unmarshalPoint(TRANSFER_BUFFER);
    }
    /** Get the end position of the cursor's current node. */ get endPosition() {
        marshalTreeCursor(this);
        C._ts_tree_cursor_end_position_wasm(this.tree[0]);
        return unmarshalPoint(TRANSFER_BUFFER);
    }
    /** Get the start index of the cursor's current node. */ get startIndex() {
        marshalTreeCursor(this);
        return C._ts_tree_cursor_start_index_wasm(this.tree[0]);
    }
    /** Get the end index of the cursor's current node. */ get endIndex() {
        marshalTreeCursor(this);
...
var Node = class {
    ...
    // Internal handle for Wasm
    /** @internal */ _children;
    /** @internal */ _namedChildren;
    /** @internal */ constructor(internal, { id, tree, startIndex, startPosition, other }){
        assertInternal(internal);
        this[0] = other;
        this.id = id;
        this.tree = tree;
   ...
   */ id;
    /** The byte index where this node starts. */ startIndex;
    /** The position where this node starts. */ startPosition;
    /** The tree that this node belongs to. */ tree;
    /** Get this node's type as a numerical id. */ get typeId() {
        marshalNode(this);
   ...
   */ get grammarId() {
    ...
    /** Get this node's type as a string. */ get type() {
   ...
   */ get isMissing() {
    ...
    /** Check if this node has been edited. */ get hasChanges() {
        marshalNode(this);
   ...
   */ get hasError() {
    ...
    /** Get the byte index where this node ends. */ get endIndex() {
        marshalNode(this);
        return C._ts_node_end_index_wasm(this.tree[0]);
    }
    /** Get the position where this node ends. */ get endPosition() {
        marshalNode(this);
        C._ts_node_end_point_wasm(this.tree[0]);
        return unmarshalPoint(TRANSFER_BUFFER);
    }
    /** Get the string content of this node. */ get text() {
        return getText(this.tree, this.startIndex, this.endIndex, this.startPosition);
    }
    /** Get this node's parse state. */ get parseState() {
        marshalNode(this);
        return C._ts_node_parse_state_wasm(this.tree[0]);
    }
    /** Get the parse state after this node. */ get nextParseState() {
        marshalNode(this);
        return C._ts_node_next_parse_state_wasm(this.tree[0]);
    }
    /** Check if this node is equal to another node. */ equals(other) {
   ...
   */ childForFieldName(fieldName) {
    ...
    /** Get the field name of this node's child at the given index. */ fieldNameForChild(index) {
        marshalNode(this);
        const address = C._ts_node_field_name_for_child_wasm(this.tree[0], index);
        if (!address) return null;
        return C.AsciiToString(address);
    }
    /** Get the field name of this node's named child at the given index. */ fieldNameForNamedChild(index) {
        marshalNode(this);
   ...
   */ childrenForFieldName(fieldName) {
    ...
    */ childrenForFieldId(fieldId) {
    ...
    /** Get the node's first child that contains or starts after the given byte offset. */ firstChildForIndex(index) {
        marshalNode(this);
        const address = TRANSFER_BUFFER + SIZE_OF_NODE;
    ...
    /** Get the node's first named child that contains or starts after the given byte offset. */ firstNamedChildForIndex(index) {
        marshalNode(this);
        const address = TRANSFER_BUFFER + SIZE_OF_NODE;
        C.setValue(address, index, "i32");
    ...
    /** Get this node's number of children. */ get childCount() {
        marshalNode(this);
   ...
   */ get namedChildCount() {
    ...
    /** Get this node's first child. */ get firstChild() {
        return this.child(0);
    }
    /**
   ...
   */ get firstNamedChild() {
    ...
    /** Get this node's last child. */ get lastChild() {
   ...
   */ descendantsOfType(types, startPosition = ZERO_POINT, endPosition = ZERO_POINT) {
    ...
    /** Get this node's next sibling. */ get nextSibling() {
        marshalNode(this);
        C._ts_node_next_sibling_wasm(this.tree[0]);
        return unmarshalNode(this.tree);
    }
    /** Get this node's previous sibling. */ get previousSibling() {
        marshalNode(this);
   ...
   */ get previousNamedSibling() {
    ...
    /** Get the node's number of descendants, including one for the node itself. */ get descendantCount() {
        marshalNode(this);
   ...
   */ childWithDescendant(descendant) {
    ...
    /** Get the smallest node within this node that spans the given byte range. */ descendantForIndex(start2, end = start2) {
    ...
    /** Get the smallest named node within this node that spans the given byte range. */ namedDescendantForIndex(start2, end = start2) {
        if (typeof start2 !== "number" || typeof end !== "number") {
            throw new Error("Arguments must be numbers");
        }
        marshalNode(this);
    ...
    /** Get the smallest node within this node that spans the given point range. */ descendantForPosition(start2, end = start2) {
    ...
    /** Get the smallest named node within this node that spans the given point range. */ namedDescendantForPosition(start2, end = start2) {
        if (!isPoint(start2) || !isPoint(end)) {
            throw new Error("Arguments must be {row, column} objects");
        }
        marshalNode(this);
   ...
   */ edit(edit) {
    ...
    /** Get the S-expression representation of this node. */ toString() {
        marshalNode(this);
...
var Language = class _Language {
   ...
   */ fields;
    /** @internal */ constructor(internal, address){
        assertInternal(internal);
        this[0] = address;
  ...
  */ get metadata() {
   ...
   */ static async load(input) {
        ...
        if (input instanceof Uint8Array) {
            ...
            const fs2 = await __turbopack_context__.A("[externals]/fs/promises [external] (fs/promises, cjs, async loader)");
...
${body2}`);
        ...
        const mod = await C.loadWebAssemblyModule(binary2, {
            loadAsync: true
        });
...
async function Module2(moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
        ...
        var require = createRequire(__TURBOPACK__import$2e$meta__.url);
    }
    ...
    var _scriptName = __TURBOPACK__import$2e$meta__.url;
    var scriptDirectory = "";
    ...
    if (ENVIRONMENT_IS_NODE) {
        ...
        if (_scriptName.startsWith("file:")) {
            scriptDirectory = __turbopack_context__.r("[externals]/path [external] (path, cjs)").dirname(__turbopack_context__.r("[externals]/url [external] (url, cjs)").fileURLToPath(_scriptName)) + "/";
        }
    ...
    function findWasmBinary() {
        ...
        return new URL(__turbopack_context__.R("[project]/node_modules/web-tree-sitter/web-tree-sitter.wasm (static in ecmascript)")).href;
    }
    ...
    __abort_js.sig = "v";
    var getHeapMax = /* @__PURE__ */ __name(()=>// Stay one Wasm page short of 4GB: while e.g. Chrome is able to allocate
    ...
    LE_ATOMICS_NATIVE_BYTE_ORDER = new Int8Array(new Int16Array([
        1
    ]).buffer)[0] === 1 ? [
        (x)=>x,
        (x)=>x,
...
var Parser = class {
    ...
    /** @internal */ [1] = 0;
    // Internal handle for Wasm
    /** @internal */ logCallback = null;
    /** The parser's current language. */ language = null;
    /**
   ...
   */ constructor(){
    ...
    /** Delete the parser, freeing its resources. */ delete() {
   ...
   */ reset() {
    ...
    /** Get the ranges of text that the parser will include when parsing. */ getIncludedRanges() {
    ...
    /** Set the logging callback that a parser should use during parsing. */ setLogger(callback) {
        if (!callback) {
    ...
    /** Get the parser's current logger. */ getLogger() {
...
var QueryError = class _QueryError extends Error {
    ...
    /** Formats an error message based on the error kind and info */ static formatMessage(kind, info2) {
        switch(kind){
...
var Query = class {
    ...
    /** @internal */ [0] = 0;
    // Internal handle for Wasm
    /** @internal */ exceededMatchLimit;
    /** @internal */ textPredicates;
    /** The names of the captures used in the query. */ captureNames;
    /** The quantifiers of the captures used in the query. */ captureQuantifiers;
    /**
   ...
   * - `set!`
   */ predicates;
    /** The properties for predicates with the operator `set!`. */ setProperties;
    /** The properties for predicates with the operator `is?`. */ assertedProperties;
    /** The properties for predicates with the operator `is-not?`. */ refutedProperties;
    /** The maximum number of in-progress matches for this cursor. */ matchLimit;
    /**
   ...
   */ constructor(language, source){
        ...
        if (!address) {
            ...
            switch(errorId){
                ...
                case QueryErrorKind.NodeName:
                    throw new QueryError(errorId, {
                        word
                    }, errorIndex, word.length);
                case QueryErrorKind.FieldName:
                    throw new QueryError(errorId, {
                        word
                    }, errorIndex, word.length);
    ...
    /** Delete the query, freeing its resources. */ delete() {
   ...
   */ captures(node, options = {}) {
    ...
    /** Get the predicates for a given pattern. */ predicatesForPattern(patternIndex) {
   ...
   */ didExceedMatchLimit() {
    ...
    /** Get the byte offset where the given pattern starts in the query's source. */ startIndexForPattern(patternIndex) {
        if (patternIndex >= this.predicates.length) {
            throw new Error(`Pattern index is ${patternIndex} but the pattern count is ${this.predicates.length}`);
        }
        return C._ts_query_start_byte_for_pattern(this[0], patternIndex);
    }
    /** Get the byte offset where the given pattern ends in the query's source. */ endIndexForPattern(patternIndex) {
        if (patternIndex >= this.predicates.length) {
            throw new Error(`Pattern index is ${patternIndex} but the pattern count is ${this.predicates.length}`);
        }
        return C._ts_query_end_byte_for_pattern(this[0], patternIndex);
    }
    /** Get the number of patterns in the query. */ patternCount() {
        return C._ts_query_pattern_count(this[0]);
    }
    /** Get the index for a given capture name. */ captureIndexForName(captureName) {
        return this.captureNames.indexOf(captureName);
    }
    /** Check if a given pattern within a query has a single root node. */ isPatternRooted(patternIndex) {
        return C._ts_query_is_pattern_rooted(this[0], patternIndex) === 1;
    }
    /** Check if a given pattern within a query has a single root node. */ isPatternNonLocal(patternIndex) {
...
//# sourceMappingURL=node_modules_web-tree-sitter_0.~elo3._.js.map